...
const FullScreenNav = () => {
  return (
    <div className="full-nav h-screen w-full absolute py-30 bg-black">
        <div className="fn-tags">
            ...
            <div className="Fn-tag cursor-pointer border-t-1 border-gray-300">
            ...
            <div className="Fn-tag cursor-pointer border-y-1 border-gray-300">
